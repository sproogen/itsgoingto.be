import { prop, compose, not, equals, length, omit, when, find, propEq, contains, __, assoc,
         adjust, set, lensProp, findIndex, update, ifElse, path, isNil, isEmpty, merge } from 'ramda'
